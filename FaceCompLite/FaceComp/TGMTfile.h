...
public:
	...
	static std::vector<std::string> GetImageFilesInDir(std::string dirPath, bool searchAllChildDir = false, bool fullPath = true);
	static std::vector<std::string> GetVideoFilesInDir(std::string dirPath, bool searchAllChildDir = false, bool fullPath = true);
	static std::vector<std::string> GetFilesInDir(std::string dirPath, bool searchAllChildDir = false, bool fullPath = true);
	static std::vector<std::string> GetChildDirInDir(std::string dirPath, bool fullPath = true);
