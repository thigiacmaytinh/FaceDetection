...
FaceComp::FaceComp()
{
	...
	std::string strConfident = GetTGMTConfig()->ReadValueString(INI_FACE_SECTION, "guest_confident", "LBPH_confident");
	m_confident = GetTGMTConfig()->ReadValueInt(INI_FACE_SECTION, strConfident, -1);
