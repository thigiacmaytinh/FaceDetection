...
static PyMethodDef methods_face[] = {
    {"MapPredictCollector", (PyCFunction)pyopencv_cv_face_face_MapPredictCollector_MapPredictCollector, METH_VARARGS | METH_KEYWORDS, "MapPredictCollector([, threshold]) -> <face_MapPredictCollector object>"},
    {"MapPredictCollector_create", (PyCFunction)pyopencv_cv_face_MapPredictCollector_create, METH_VARARGS | METH_KEYWORDS, "MapPredictCollector_create([, threshold]) -> retval"},
    {"MinDistancePredictCollector", (PyCFunction)pyopencv_cv_face_face_MinDistancePredictCollector_MinDistancePredictCollector, METH_VARARGS | METH_KEYWORDS, "MinDistancePredictCollector([, threshold]) -> <face_MinDistancePredictCollector object>"},
    ...
    {"StatPredictCollector", (PyCFunction)pyopencv_cv_face_face_StatPredictCollector_StatPredictCollector, METH_VARARGS | METH_KEYWORDS, "StatPredictCollector([, threshold]) -> <face_StatPredictCollector object>"},
    {"StatPredictCollector_create", (PyCFunction)pyopencv_cv_face_StatPredictCollector_create, METH_VARARGS | METH_KEYWORDS, "StatPredictCollector_create([, threshold]) -> retval"},
    {"StdPredictCollector", (PyCFunction)pyopencv_cv_face_face_StdPredictCollector_StdPredictCollector, METH_VARARGS | METH_KEYWORDS, "StdPredictCollector([, threshold[, avg]]) -> <face_StdPredictCollector object>"},
    {"StdPredictCollector_create", (PyCFunction)pyopencv_cv_face_StdPredictCollector_create, METH_VARARGS | METH_KEYWORDS, "StdPredictCollector_create([, threshold[, avg]]) -> retval"},
    {"TopNPredictCollector", (PyCFunction)pyopencv_cv_face_face_TopNPredictCollector_TopNPredictCollector, METH_VARARGS | METH_KEYWORDS, "TopNPredictCollector([, size[, threshold]]) -> <face_TopNPredictCollector object>"},
    {"TopNPredictCollector_create", (PyCFunction)pyopencv_cv_face_TopNPredictCollector_create, METH_VARARGS | METH_KEYWORDS, "TopNPredictCollector_create([, size[, threshold]]) -> retval"},
    {"VectorPredictCollector", (PyCFunction)pyopencv_cv_face_face_VectorPredictCollector_VectorPredictCollector, METH_VARARGS | METH_KEYWORDS, "VectorPredictCollector([, threshold]) -> <face_VectorPredictCollector object>"},
    {"VectorPredictCollector_create", (PyCFunction)pyopencv_cv_face_VectorPredictCollector_create, METH_VARARGS | METH_KEYWORDS, "VectorPredictCollector_create([, threshold]) -> retval"},
