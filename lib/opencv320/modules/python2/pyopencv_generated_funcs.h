...
static PyObject* pyopencv_cv_aruco_estimatePoseBoard(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "corners", "ids", "board", "cameraMatrix", "distCoeffs", "rvec", "tvec", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOOO|OO:estimatePoseBoard", (char**)keywords, &pyobj_corners, &pyobj_ids, &pyobj_board, &pyobj_cameraMatrix, &pyobj_distCoeffs, &pyobj_rvec, &pyobj_tvec) &&
        pyopencv_to(pyobj_corners, corners, ArgInfo("corners", 0)) &&
        pyopencv_to(pyobj_ids, ids, ArgInfo("ids", 0)) &&
        pyopencv_to(pyobj_board, board, ArgInfo("board", 0)) &&
        pyopencv_to(pyobj_cameraMatrix, cameraMatrix, ArgInfo("cameraMatrix", 0)) &&
        ...
        pyopencv_to(pyobj_tvec, tvec, ArgInfo("tvec", 1)) )
    {
        ERRWRAP2(retval = cv::aruco::estimatePoseBoard(corners, ids, board, cameraMatrix, distCoeffs, rvec, tvec));
        return Py_BuildValue("(NNN)", pyopencv_from(retval), pyopencv_from(rvec), pyopencv_from(tvec));
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_cv_aruco_estimatePoseCharucoBoard(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "charucoCorners", "charucoIds", "board", "cameraMatrix", "distCoeffs", "rvec", "tvec", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOOO|OO:estimatePoseCharucoBoard", (char**)keywords, &pyobj_charucoCorners, &pyobj_charucoIds, &pyobj_board, &pyobj_cameraMatrix, &pyobj_distCoeffs, &pyobj_rvec, &pyobj_tvec) &&
        pyopencv_to(pyobj_charucoCorners, charucoCorners, ArgInfo("charucoCorners", 0)) &&
        pyopencv_to(pyobj_charucoIds, charucoIds, ArgInfo("charucoIds", 0)) &&
        pyopencv_to(pyobj_board, board, ArgInfo("board", 0)) &&
        pyopencv_to(pyobj_cameraMatrix, cameraMatrix, ArgInfo("cameraMatrix", 0)) &&
        ...
        pyopencv_to(pyobj_tvec, tvec, ArgInfo("tvec", 1)) )
    {
        ERRWRAP2(retval = cv::aruco::estimatePoseCharucoBoard(charucoCorners, charucoIds, board, cameraMatrix, distCoeffs, rvec, tvec));
        return Py_BuildValue("(NNN)", pyopencv_from(retval), pyopencv_from(rvec), pyopencv_from(tvec));
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_cv_aruco_interpolateCornersCharuco(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "markerCorners", "markerIds", "image", "board", "charucoCorners", "charucoIds", "cameraMatrix", "distCoeffs", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOO|OOOO:interpolateCornersCharuco", (char**)keywords, &pyobj_markerCorners, &pyobj_markerIds, &pyobj_image, &pyobj_board, &pyobj_charucoCorners, &pyobj_charucoIds, &pyobj_cameraMatrix, &pyobj_distCoeffs) &&
        pyopencv_to(pyobj_markerCorners, markerCorners, ArgInfo("markerCorners", 0)) &&
        pyopencv_to(pyobj_markerIds, markerIds, ArgInfo("markerIds", 0)) &&
        pyopencv_to(pyobj_image, image, ArgInfo("image", 0)) &&
        pyopencv_to(pyobj_board, board, ArgInfo("board", 0)) &&
        ...
        pyopencv_to(pyobj_distCoeffs, distCoeffs, ArgInfo("distCoeffs", 0)) )
    {
        ERRWRAP2(retval = cv::aruco::interpolateCornersCharuco(markerCorners, markerIds, image, board, charucoCorners, charucoIds, cameraMatrix, distCoeffs));
...
static PyObject* pyopencv_cv_face_face_MapPredictCollector_MapPredictCollector(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::face;

    double threshold=DBL_MAX;
    pyopencv_face_MapPredictCollector_t* self = 0;

    const char* keywords[] = { "threshold", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "|d:MapPredictCollector", (char**)keywords, &threshold) )
    {
        self = PyObject_NEW(pyopencv_face_MapPredictCollector_t, &pyopencv_face_MapPredictCollector_Type);
        new (&(self->v)) Ptr<cv::face::MapPredictCollector>(); // init Ptr with placement new
        if(self) ERRWRAP2(self->v.reset(new cv::face::MapPredictCollector(threshold)));
        return (PyObject*)self;
    }
...
static PyObject* pyopencv_cv_face_MapPredictCollector_create(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::face;

    double threshold=DBL_MAX;
    Ptr<MapPredictCollector> retval;

    const char* keywords[] = { "threshold", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "|d:MapPredictCollector_create", (char**)keywords, &threshold) )
    {
        ERRWRAP2(retval = cv::face::MapPredictCollector::create(threshold));
        return pyopencv_from(retval);
    }
...
static PyObject* pyopencv_cv_face_face_MinDistancePredictCollector_MinDistancePredictCollector(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "threshold", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "|d:MinDistancePredictCollector", (char**)keywords, &threshold) )
    {
        ...
        if(self) ERRWRAP2(self->v.reset(new cv::face::MinDistancePredictCollector(threshold)));
        return (PyObject*)self;
    }
...
static PyObject* pyopencv_cv_face_face_StatPredictCollector_StatPredictCollector(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::face;

    double threshold=DBL_MAX;
    pyopencv_face_StatPredictCollector_t* self = 0;

    const char* keywords[] = { "threshold", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "|d:StatPredictCollector", (char**)keywords, &threshold) )
    {
        self = PyObject_NEW(pyopencv_face_StatPredictCollector_t, &pyopencv_face_StatPredictCollector_Type);
        new (&(self->v)) Ptr<cv::face::StatPredictCollector>(); // init Ptr with placement new
        if(self) ERRWRAP2(self->v.reset(new cv::face::StatPredictCollector(threshold)));
        return (PyObject*)self;
    }
...
static PyObject* pyopencv_cv_face_StatPredictCollector_create(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::face;

    double threshold=DBL_MAX;
    Ptr<StatPredictCollector> retval;

    const char* keywords[] = { "threshold", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "|d:StatPredictCollector_create", (char**)keywords, &threshold) )
    {
        ERRWRAP2(retval = cv::face::StatPredictCollector::create(threshold));
        return pyopencv_from(retval);
    }
...
static PyObject* pyopencv_cv_face_face_StdPredictCollector_StdPredictCollector(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::face;

    double threshold=DBL_MAX;
    double avg=0;
    pyopencv_face_StdPredictCollector_t* self = 0;

    const char* keywords[] = { "threshold", "avg", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "|dd:StdPredictCollector", (char**)keywords, &threshold, &avg) )
    {
        self = PyObject_NEW(pyopencv_face_StdPredictCollector_t, &pyopencv_face_StdPredictCollector_Type);
        new (&(self->v)) Ptr<cv::face::StdPredictCollector>(); // init Ptr with placement new
        if(self) ERRWRAP2(self->v.reset(new cv::face::StdPredictCollector(threshold, avg)));
        return (PyObject*)self;
    }
...
static PyObject* pyopencv_cv_face_StdPredictCollector_create(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::face;

    double threshold=DBL_MAX;
    double avg=0;
    Ptr<StdPredictCollector> retval;

    const char* keywords[] = { "threshold", "avg", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "|dd:StdPredictCollector_create", (char**)keywords, &threshold, &avg) )
    {
        ERRWRAP2(retval = cv::face::StdPredictCollector::create(threshold, avg));
        return pyopencv_from(retval);
    }
...
static PyObject* pyopencv_cv_face_face_TopNPredictCollector_TopNPredictCollector(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::face;

    size_t size=5;
    double threshold=DBL_MAX;
    pyopencv_face_TopNPredictCollector_t* self = 0;

    const char* keywords[] = { "size", "threshold", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "|Id:TopNPredictCollector", (char**)keywords, &size, &threshold) )
    {
        self = PyObject_NEW(pyopencv_face_TopNPredictCollector_t, &pyopencv_face_TopNPredictCollector_Type);
        new (&(self->v)) Ptr<cv::face::TopNPredictCollector>(); // init Ptr with placement new
        if(self) ERRWRAP2(self->v.reset(new cv::face::TopNPredictCollector(size, threshold)));
        return (PyObject*)self;
    }
...
static PyObject* pyopencv_cv_face_TopNPredictCollector_create(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::face;

    size_t size=5;
    double threshold=DBL_MAX;
    Ptr<TopNPredictCollector> retval;

    const char* keywords[] = { "size", "threshold", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "|Id:TopNPredictCollector_create", (char**)keywords, &size, &threshold) )
    {
        ERRWRAP2(retval = cv::face::TopNPredictCollector::create(size, threshold));
        return pyopencv_from(retval);
    }
...
static PyObject* pyopencv_cv_face_face_VectorPredictCollector_VectorPredictCollector(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::face;

    double threshold=DBL_MAX;
    pyopencv_face_VectorPredictCollector_t* self = 0;

    const char* keywords[] = { "threshold", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "|d:VectorPredictCollector", (char**)keywords, &threshold) )
    {
        self = PyObject_NEW(pyopencv_face_VectorPredictCollector_t, &pyopencv_face_VectorPredictCollector_Type);
        new (&(self->v)) Ptr<cv::face::VectorPredictCollector>(); // init Ptr with placement new
        if(self) ERRWRAP2(self->v.reset(new cv::face::VectorPredictCollector(threshold)));
        return (PyObject*)self;
    }
...
static PyObject* pyopencv_cv_face_VectorPredictCollector_create(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::face;

    double threshold=DBL_MAX;
    Ptr<VectorPredictCollector> retval;

    const char* keywords[] = { "threshold", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "|d:VectorPredictCollector_create", (char**)keywords, &threshold) )
    {
        ERRWRAP2(retval = cv::face::VectorPredictCollector::create(threshold));
        return pyopencv_from(retval);
    }
